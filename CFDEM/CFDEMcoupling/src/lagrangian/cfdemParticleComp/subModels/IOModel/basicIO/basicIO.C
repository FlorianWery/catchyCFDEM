...
int basicIO::dumpDEMdata() const
{
    if (dumpNow())
    {
        ...
        streamDataToPath(lagPath_, particleCloud_.velocities(),nPProc_,"origId","origId","labelField","");
        streamDataToPath(lagPath_, particleCloud_.velocities(),nPProc_,"origProcId","origProcId","labelField","");
    }
    return nPProc_;
}
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
