...
Foam::chemistryGSReductionMethods::DAC<CompType, GThermoType, SThermoType>::DAC
(
  ...
  if (j<searchInitSolidSet_.size())
  {
    ...
    if (automaticSIS_)
    {
        ...
        forAll(fuelSpecies_, i)
        {
            ...
            scalar curMm =
                this->chemistry_.gasSpecieThermo()[fuelSpeciesID_[i]].W();
        ...
        forAll(fuelSpecies_, i)
        {
            ...
            scalar curMm = this->chemistry_.gasSpecieThermo()[curID].W();
...
template<class CompType, class GThermoType, class SThermoType>
void Foam::chemistryGSReductionMethods::DAC<CompType, GThermoType, SThermoType>::reduceMechanism
(
    const scalar p,
    const scalar T,
    const scalarField& c,
