...
Foam::autoPtr<Foam::chemistryGSReductionMethod<CompType, GThermoType, SThermoType>>
Foam::chemistryGSReductionMethod<CompType, GThermoType, SThermoType>::New
(
...
)
{
    ...
    const word methodTypeName =
        methodName
      + '<' + CompType::typeName + ',' + GThermoType::typeName() + ',' + SThermoType::typeName() + '>';
    ...
    return autoPtr<chemistryGSReductionMethod<CompType, GThermoType, SThermoType>>
    (
