...
Foam::chemistryGSTabulationMethod<CompType, GThermoType, SThermoType>::chemistryGSTabulationMethod
(
...
template<class CompType, class GThermoType, class SThermoType>
Foam::chemistryGSTabulationMethod<CompType, GThermoType, SThermoType>::
~chemistryGSTabulationMethod()
{}
