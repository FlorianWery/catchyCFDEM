...
Foam::autoPtr<Foam::chemistryGSTabulationMethod<CompType, GThermoType, SThermoType>>
Foam::chemistryGSTabulationMethod<CompType, GThermoType, SThermoType>::New
(
...
)
{
    ...
    const word methodTypeName =
        methodName + '<' + CompType::typeName + ',' + GThermoType::typeName() + ',' + SThermoType::typeName()
        + '>';
    ...
    if (cstrIter == dictionaryConstructorTablePtr_->end())
    {
        ...
        thisCmpts.append
        (
            basicThermo::splitThermoName(GThermoType::typeName(), 5)
        );
    ...
    return autoPtr<chemistryGSTabulationMethod<CompType, GThermoType, SThermoType>>
    (
