...
Foam::binaryNode<CompType, GThermoType, SThermoType>::binaryNode()
:
    leafLeft_(nullptr),
    leafRight_(nullptr),
    nodeLeft_(nullptr),
...
Foam::binaryNode<CompType, GThermoType, SThermoType>::binaryNode
(
    chemPointISAT<CompType, GThermoType, SThermoType>* elementLeft,
    chemPointISAT<CompType, GThermoType, SThermoType>* elementRight,
    binaryNode<CompType, GThermoType, SThermoType>* parent
)
:
...
template<class CompType, class GThermoType, class SThermoType>
void Foam::binaryNode<CompType, GThermoType, SThermoType>::calcV
(
    chemPointISAT<CompType, GThermoType, SThermoType>*& elementLeft,
    chemPointISAT<CompType, GThermoType, SThermoType>*& elementRight,
    scalarField& v
...
template<class CompType, class GThermoType, class SThermoType>
Foam::scalar Foam::binaryNode<CompType, GThermoType, SThermoType>::calcA
(
    chemPointISAT<CompType, GThermoType, SThermoType>* elementLeft,
    chemPointISAT<CompType, GThermoType, SThermoType>* elementRight
)
