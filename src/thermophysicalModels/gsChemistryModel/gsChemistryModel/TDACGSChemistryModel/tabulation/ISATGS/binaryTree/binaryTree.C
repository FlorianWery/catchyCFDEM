...
void Foam::binaryTree<CompType, GThermoType, SThermotype>::insertNode
(
    chP*& phi0,
    bn*& newNode
)
...
template<class CompType, class GThermoType, class SThermotype>
bool Foam::binaryTree<CompType, GThermoType, SThermotype>::inSubTree
(
...
template<class CompType, class GThermoType, class SThermotype>
void Foam::binaryTree<CompType, GThermoType, SThermotype>::deleteSubTree(bn* subTreeRoot)
{
...
template<class CompType, class GThermoType, class SThermotype>
void Foam::binaryTree<CompType, GThermoType, SThermotype>::transplant(bn* u, bn* v)
{
    if (v != nullptr)
    {
        // u is root_
...
template<class CompType, class GThermoType, class SThermotype>
Foam::chemPointISAT<CompType, GThermoType, SThermotype>*
Foam::binaryTree<CompType, GThermoType, SThermotype>::chemPSibling(bn* y)
{
    if (y->parent() != nullptr)
    {
...
template<class CompType, class GThermoType, class SThermoType>
Foam::chemPointISAT<CompType, GThermoType, SThermoType>*
Foam::binaryTree<CompType, GThermoType, SThermoType>::chemPSibling(chP* x)
{
    if (size_>1)
    {
...
template<class CompType, class GThermoType, class SThermoType>
Foam::binaryNode<CompType, GThermoType, SThermoType>*
Foam::binaryTree<CompType, GThermoType, SThermoType>::nodeSibling(bn* y)
{
    if (y->parent()!=nullptr)
    {
...
template<class CompType, class GThermoType, class SThermoType>
Foam::binaryNode<CompType, GThermoType, SThermoType>*
Foam::binaryTree<CompType, GThermoType, SThermoType>::nodeSibling(chP* x)
{
    if (size_>1)
    {
        if (x == x->node()->leafLeft())
...
template<class CompType, class GThermoType, class SThermoType>
void Foam::binaryTree<CompType, GThermoType, SThermoType>::deleteAllNode(bn* subTreeRoot)
{
    if (subTreeRoot != nullptr)
    {
...
template<class CompType, class GThermoType, class SThermoType>
Foam::binaryTree<CompType, GThermoType, SThermoType>::binaryTree
(
...
template<class CompType, class GThermoType, class SThermoType>
Foam::label Foam::binaryTree<CompType, GThermoType, SThermoType>::depth(bn* subTreeRoot)
{
...
template<class CompType, class GThermoType, class SThermoType>
void Foam::binaryTree<CompType, GThermoType, SThermoType>::insertNewLeaf
(
    const scalarField& phiq,
...
template<class CompType, class GThermoType, class SThermoType>
void Foam::binaryTree<CompType, GThermoType, SThermoType>::binaryTreeSearch
(
    const scalarField& phiq,
    bn* node,
    chP*& nearest
...
template<class CompType, class GThermoType, class SThermoType>
bool Foam::binaryTree<CompType, GThermoType, SThermoType>::secondaryBTSearch
(
    const scalarField& phiq,
    chP*& x
)
...
template<class CompType, class GThermoType, class SThermoType>
void Foam::binaryTree<CompType, GThermoType, SThermoType>::deleteLeaf(chP*& phi0)
{
...
template<class CompType, class GThermoType, class SThermoType>
void Foam::binaryTree<CompType, GThermoType, SThermoType>::balance()
{
...
template<class CompType, class GThermoType, class SThermoType>
Foam::chemPointISAT<CompType, GThermoType, SThermoType>*
Foam::binaryTree<CompType, GThermoType, SThermoType>::treeMin(bn* subTreeRoot)
{
    if (subTreeRoot!=nullptr)
    {
...
template<class CompType, class GThermoType, class SThermoType>
Foam::chemPointISAT<CompType, GThermoType, SThermoType>*
Foam::binaryTree<CompType, GThermoType, SThermoType>::treeSuccessor(chP* x)
{
    if (size_>1)
    {
        if (x == x->node()->leafLeft())
...
template<class CompType, class GThermoType, class SThermoType>
void Foam::binaryTree<CompType, GThermoType, SThermoType>::clear()
{
...
template<class CompType, class GThermoType, class SThermoType>
bool Foam::binaryTree<CompType, GThermoType, SThermoType>::isFull()
{
...
template<class CompType, class GThermoType, class SThermoType>
void Foam::binaryTree<CompType, GThermoType, SThermoType>::resetNumRetrieve()
{
